...
VALUES
(NOW(), 0, 'ACTIVE', 'johndoe@example.com', 'John', 'Doe', '555-1234', '2020-01-15', 1, 1, 95000.00, NULL),
(NOW(), 0, 'ACTIVE', 'janedoe@example.com', 'Jane', 'Doe', '555-2345', '2021-03-01', 1, 1, 85000.00, 1);
...
('johndoe', '$2a$12$6PBqiiu0QGGZ6JkwweutsOZlSRhtNpDCnXv3zkBs6Q5y8no4.MoXS', 1, now(), 0, 'ACTIVE'),
('janedoe', '$2a$12$6PBqiiu0QGGZ6JkwweutsOZlSRhtNpDCnXv3zkBs6Q5y8no4.MoXS', 2, now(), 0, 'ACTIVE');
...
(NOW(), 0, 'ACTIVE', 2, 2, 2, '2022-06-20', NULL);
